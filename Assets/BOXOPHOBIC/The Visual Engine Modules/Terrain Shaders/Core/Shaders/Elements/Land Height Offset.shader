...
Shader "BOXOPHOBIC/The Visual Engine/Elements/Land Height Offset"
{
	Properties
	{
		[StyledMessage(Info, Use the Height Offset elements to add noise variation to the height elements., 0, 15)]_ElementMessage("Element Message", Float) = 0
...
Node;AmplifyShaderEditor.RangedFloatNode;112;-2048,-1536;Half;False;Property;_ElementMessage;Element Message;0;0;Create;True;0;0;0;True;1;StyledMessage(Info, Use the Height Offset elements to add noise variation to the height elements., 0, 15);False;0;0;1;1;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=82A5B3507B988F10D176DAB213A807CBA1D7905D