// Upgrade NOTE: upgraded instancing buffer 'BOXOPHOBICTheVisualEngineElementsLandHeightSetter' to new syntax.

// Made with Amplify Shader Editor v1.9.6.3
// Available at the Unity Asset Store - http://u3d.as/y3X 
Shader "BOXOPHOBIC/The Visual Engine/Elements/Land Height Setter"
{
	Properties
	{
		[StyledMessage(Info, Use the Height elements to offset the height of the Terrain or Blanket shaders.. Element Texture R and Particle Color R are used as value multipliers. Element Texture A and Particle Color A are used as alpha masks., 0, 15)]_ElementMessage("Element Message", Float) = 0
	...
	LOD 100
		...
		Pass
		{
			...
			UNITY_INSTANCING_BUFFER_START(BOXOPHOBICTheVisualEngineElementsLandHeightSetter)
				UNITY_DEFINE_INSTANCED_PROP(half4, _ElementParams)
#define _ElementParams_arr BOXOPHOBICTheVisualEngineElementsLandHeightSetter
			UNITY_INSTANCING_BUFFER_END(BOXOPHOBICTheVisualEngineElementsLandHeightSetter)
			...
			v2f vert ( appdata v )
			{
				...
				half temp_output_7_0_g23909 = _SeasonRemap.x;
				half temp_output_10_0_g23909 = ( _SeasonRemap.y - temp_output_7_0_g23909 );
				half TVE_SeasonLerp54_g23883 = saturate( saturate( ( ( TVE_SeasonLerp - temp_output_7_0_g23909 ) / temp_output_10_0_g23909 ) ) );
				...
				half2 vertexToFrag11_g23919 = ( ( lerpResult1899_g23883 * (_MainUVs).xy ) + (_MainUVs).zw );
				o.ase_texcoord1.yz = vertexToFrag11_g23919;
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half2 vertexToFrag11_g23919 = i.ase_texcoord1.yz;
				half4 MainTex_RGBA587_g23883 = tex2D( _MainTex, vertexToFrag11_g23919 );
				half3 temp_cast_0 = (0.0001).xxx;
				half3 temp_cast_1 = (0.9999).xxx;
				half3 clampResult17_g23913 = clamp( (MainTex_RGBA587_g23883).rgb , temp_cast_0 , temp_cast_1 );
				half temp_output_7_0_g23895 = _MainTexColorRemap.x;
				half3 temp_cast_2 = (temp_output_7_0_g23895).xxx;
				half temp_output_10_0_g23895 = ( _MainTexColorRemap.y - temp_output_7_0_g23895 );
				half3 temp_output_1765_0_g23883 = saturate( ( ( clampResult17_g23913 - temp_cast_2 ) / temp_output_10_0_g23895 ) );
				...
				half clampResult17_g23914 = clamp( (MainTex_RGBA587_g23883).a , 0.0001 , 0.9999 );
				half temp_output_7_0_g23894 = _MainTexAlphaRemap.x;
				half temp_output_10_0_g23894 = ( _MainTexAlphaRemap.y - temp_output_7_0_g23894 );
				half Element_Remap_A74_g23883 = saturate( ( ( clampResult17_g23914 - temp_output_7_0_g23894 ) / ( temp_output_10_0_g23894 + 0.0001 ) ) );
				half Element_Params_A1737_g23883 = _ElementParams_Instance.w;
				half clampResult17_g23892 = clamp( saturate( ( 1.0 - distance( (i.ase_texcoord2.xy*2.0 + -1.0) , float2( 0,0 ) ) ) ) , 0.0001 , 0.9999 );
				half temp_output_7_0_g23893 = _MainTexFalloffRemap.x;
				half temp_output_10_0_g23893 = ( _MainTexFalloffRemap.y - temp_output_7_0_g23893 );
				half Element_Falloff1883_g23883 = saturate( ( ( clampResult17_g23892 - temp_output_7_0_g23893 ) / ( temp_output_10_0_g23893 + 0.0001 ) ) );
				half temp_output_7_0_g23918 = 1.0;
				half temp_output_10_0_g23918 = ( _ElementVolumeFadeValue - temp_output_7_0_g23918 );
				half lerpResult18_g23916 = lerp( 1.0 , saturate( ( ( saturate( ( distance( WorldPosition , (TVE_RenderBasePositionR).xyz ) / (TVE_RenderBasePositionR).w ) ) - temp_output_7_0_g23918 ) / temp_output_10_0_g23918 ) ) , _ElementVolumeFadeMode);
				half Element_Alpha56_g23883 = ( _ElementIntensity * Element_Remap_A74_g23883 * Element_Params_A1737_g23883 * i.ase_color.a * Element_Falloff1883_g23883 * lerpResult18_g23916 );
...
#define _ElementParams_arr BOXOPHOBICTheVisualEngineElementsLandHeightSetter
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half3 Input_Color94_g23908 = temp_cast_3;
				half3 break68_g23908 = Input_Color94_g23908;
				half clampResult80_g23908 = clamp( max( max( break68_g23908.x , break68_g23908.y ) , break68_g23908.z ) , 0.1 , 10000.0 );
				half4 color1938_g23883 = IsGammaSpace() ? half4(0,0.2,1,0) : half4(0,0.03310476,1,0);
				half3 Input_Tint76_g23908 = (color1938_g23883).rgb;
				half3 Element_Valid47_g23908 = ( clampResult80_g23908 * Input_Tint76_g23908 );
				half clampResult17_g23914 = clamp( (MainTex_RGBA587_g23883).a , 0.0001 , 0.9999 );
				half temp_output_7_0_g23894 = _MainTexAlphaRemap.x;
				half temp_output_10_0_g23894 = ( _MainTexAlphaRemap.y - temp_output_7_0_g23894 );
				half Element_Remap_A74_g23883 = saturate( ( ( clampResult17_g23914 - temp_output_7_0_g23894 ) / ( temp_output_10_0_g23894 + 0.0001 ) ) );
				...
				half Element_Alpha56_g23883 = ( _ElementIntensity * Element_Remap_A74_g23883 * Element_Params_A1737_g23883 * i.ase_color.a * Element_Falloff1883_g23883 * lerpResult18_g23916 );
				half Final_Extras_A241_g23883 = Element_Alpha56_g23883;
				half Input_Alpha48_g23908 = Final_Extras_A241_g23883;
				half4 appendResult58_g23908 = (half4(Element_Valid47_g23908 , Input_Alpha48_g23908));
				
				
				finalColor = appendResult58_g23908;
				return finalColor;
			}
			ENDCG
		}
...
Node;AmplifyShaderEditor.FunctionNode;216;-512,-896;Inherit;False;Element Shader;10;;23883;0e972c73cae2ee54ea51acc9738801d0;12,477,3,1778,3,478,0,1824,0,1814,1,145,1,1784,2,481,2,1935,0,1933,0,1904,1,1907,1;1;1974;FLOAT;0;False;2;FLOAT4;0;FLOAT4;1779
