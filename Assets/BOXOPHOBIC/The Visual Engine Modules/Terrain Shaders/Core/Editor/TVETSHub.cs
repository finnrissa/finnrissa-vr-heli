...
namespace TheVisualEngine
{
    public class TVETSHub : EditorWindow
    {
        ...
        string autorunPath;
        string assetFolder = "Assets/BOXOPHOBIC/The Visual Engine Modules/Terrain Shaders";
        ...
        [MenuItem("Window/BOXOPHOBIC/The Visual Engine/Hub/Terrain Shaders", false, 1006)]
        ...
        void OnGUI()
        {
            ...
            {
                EditorGUILayout.HelpBox("Welcome to the Terrain Shaders Module for The Visual Engine! Choose the render pipeline used in your project to make the shaders compatible with the current pipeline!", MessageType.Info, true);
        ...
        void SetDefineSymbols()
        {
            ...
            if (!defineSymbols.Contains("THE_VISUAL_ENGINE_TERRAIN"))
            {
                defineSymbols += ";THE_VISUAL_ENGINE_TERRAIN;";
