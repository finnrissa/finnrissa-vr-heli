	...
	SubShader
	{
		/*ase_subshader_options:Name=Additional Options
			...
			Option:Receive Shadows:false,true:true
				true:SetDefine:Forward:pragma shader_feature_local _ _RECEIVE_SHADOWS_OFF
				true:SetDefine:GBuffer:pragma shader_feature_local _ _RECEIVE_SHADOWS_OFF
				false:RemoveDefine:Forward:pragma shader_feature_local _ _RECEIVE_SHADOWS_OFF
				false:RemoveDefine:GBuffer:pragma shader_feature_local _ _RECEIVE_SHADOWS_OFF
			Option:Receive Specular:false,true:true
				true:SetDefine:Forward:pragma shader_feature_local_fragment _ _SPECULARHIGHLIGHTS_OFF
				true:SetDefine:GBuffer:pragma shader_feature_local_fragment _ _SPECULARHIGHLIGHTS_OFF
				false:RemoveDefine:Forward:pragma shader_feature_local_fragment _ _SPECULARHIGHLIGHTS_OFF
				false:RemoveDefine:GBuffer:pragma shader_feature_local_fragment _ _SPECULARHIGHLIGHTS_OFF		
