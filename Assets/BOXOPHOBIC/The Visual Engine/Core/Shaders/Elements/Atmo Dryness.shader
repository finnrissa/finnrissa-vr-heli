...
#define _ElementParams_arr BOXOPHOBICTheVisualEngineElementsAtmoDryness
			...
			v2f vert ( appdata v )
			{
				...
				half2 vertexToFrag11_g23489 = ( ( lerpResult1899_g23453 * (_MainUVs).xy ) + (_MainUVs).zw );
				o.ase_texcoord1.yz = vertexToFrag11_g23489;
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half2 vertexToFrag11_g23489 = i.ase_texcoord1.yz;
				half4 MainTex_RGBA587_g23453 = tex2D( _MainTex, vertexToFrag11_g23489 );
				half3 temp_cast_0 = (0.0001).xxx;
				half3 temp_cast_1 = (0.9999).xxx;
				half3 clampResult17_g23483 = clamp( (MainTex_RGBA587_g23453).rgb , temp_cast_0 , temp_cast_1 );
				...
				half3 temp_output_1765_0_g23453 = saturate( ( ( clampResult17_g23483 - temp_cast_2 ) / temp_output_10_0_g23465 ) );
				...
				half clampResult17_g23484 = clamp( (MainTex_RGBA587_g23453).a , 0.0001 , 0.9999 );
				half temp_output_7_0_g23464 = _MainTexAlphaRemap.x;
				half temp_output_10_0_g23464 = ( _MainTexAlphaRemap.y - temp_output_7_0_g23464 );
				half Element_Remap_A74_g23453 = saturate( ( ( clampResult17_g23484 - temp_output_7_0_g23464 ) / ( temp_output_10_0_g23464 + 0.0001 ) ) );
				...
				half temp_output_7_0_g23488 = 1.0;
				half temp_output_10_0_g23488 = ( _ElementVolumeFadeValue - temp_output_7_0_g23488 );
				half lerpResult18_g23486 = lerp( 1.0 , saturate( ( ( saturate( ( distance( WorldPosition , (TVE_RenderBasePositionR).xyz ) / (TVE_RenderBasePositionR).w ) ) - temp_output_7_0_g23488 ) / temp_output_10_0_g23488 ) ) , _ElementVolumeFadeMode);
				half Element_Alpha56_g23453 = ( _ElementIntensity * Element_Remap_A74_g23453 * Element_Params_A1737_g23453 * i.ase_color.a * Element_Falloff1883_g23453 * lerpResult18_g23486 );
...
#define _ElementParams_arr BOXOPHOBICTheVisualEngineElementsAtmoDryness
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half3 Input_Color94_g23476 = temp_cast_3;
				half3 break68_g23476 = Input_Color94_g23476;
				half clampResult80_g23476 = clamp( max( max( break68_g23476.x , break68_g23476.y ) , break68_g23476.z ) , 0.1 , 10000.0 );
				half4 color1872_g23453 = IsGammaSpace() ? half4(1,0.6,0,0) : half4(1,0.3185468,0,0);
				half3 Input_Tint76_g23476 = (color1872_g23453).rgb;
				half3 Element_Valid47_g23476 = ( clampResult80_g23476 * Input_Tint76_g23476 );
				half clampResult17_g23484 = clamp( (MainTex_RGBA587_g23453).a , 0.0001 , 0.9999 );
				half temp_output_7_0_g23464 = _MainTexAlphaRemap.x;
				half temp_output_10_0_g23464 = ( _MainTexAlphaRemap.y - temp_output_7_0_g23464 );
				half Element_Remap_A74_g23453 = saturate( ( ( clampResult17_g23484 - temp_output_7_0_g23464 ) / ( temp_output_10_0_g23464 + 0.0001 ) ) );
				...
				half Element_Alpha56_g23453 = ( _ElementIntensity * Element_Remap_A74_g23453 * Element_Params_A1737_g23453 * i.ase_color.a * Element_Falloff1883_g23453 * lerpResult18_g23486 );
				half Final_Extras_A241_g23453 = Element_Alpha56_g23453;
				half Input_Alpha48_g23476 = Final_Extras_A241_g23453;
				half4 appendResult58_g23476 = (half4(Element_Valid47_g23476 , Input_Alpha48_g23476));
				
				
				finalColor = appendResult58_g23476;
				return finalColor;
			}
			ENDCG
		}
...
Node;AmplifyShaderEditor.FunctionNode;167;-384,-1152;Inherit;False;Element Shader;10;;23453;0e972c73cae2ee54ea51acc9738801d0;12,477,1,1778,1,478,0,1824,0,1814,0,145,0,1784,0,481,0,1935,1,1933,1,1904,1,1907,1;1;1974;FLOAT;0;False;2;FLOAT4;0;FLOAT4;1779
...
ASEEND*/
//CHKSM=D8C39DD2A955CC0EC3E78840BCA35CDE6F7F37A4