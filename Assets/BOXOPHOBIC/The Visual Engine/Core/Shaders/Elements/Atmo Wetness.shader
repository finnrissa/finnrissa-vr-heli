...
#define _ElementParams_arr BOXOPHOBICTheVisualEngineElementsAtmoWetness
			...
			v2f vert ( appdata v )
			{
				...
				half temp_output_7_0_g24372 = _SeasonRemap.x;
				half temp_output_10_0_g24372 = ( _SeasonRemap.y - temp_output_7_0_g24372 );
				half TVE_SeasonLerp54_g24346 = saturate( saturate( ( ( TVE_SeasonLerp - temp_output_7_0_g24372 ) / temp_output_10_0_g24372 ) ) );
				...
				half2 vertexToFrag11_g24382 = ( ( lerpResult1899_g24346 * (_MainUVs).xy ) + (_MainUVs).zw );
				o.ase_texcoord1.yz = vertexToFrag11_g24382;
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half2 vertexToFrag11_g24382 = i.ase_texcoord1.yz;
				half4 MainTex_RGBA587_g24346 = tex2D( _MainTex, vertexToFrag11_g24382 );
				half3 temp_cast_0 = (0.0001).xxx;
				half3 temp_cast_1 = (0.9999).xxx;
				half3 clampResult17_g24376 = clamp( (MainTex_RGBA587_g24346).rgb , temp_cast_0 , temp_cast_1 );
				half temp_output_7_0_g24358 = _MainTexColorRemap.x;
				half3 temp_cast_2 = (temp_output_7_0_g24358).xxx;
				half temp_output_10_0_g24358 = ( _MainTexColorRemap.y - temp_output_7_0_g24358 );
				half3 temp_output_1765_0_g24346 = saturate( ( ( clampResult17_g24376 - temp_cast_2 ) / temp_output_10_0_g24358 ) );
				...
				half clampResult17_g24377 = clamp( (MainTex_RGBA587_g24346).a , 0.0001 , 0.9999 );
				half temp_output_7_0_g24357 = _MainTexAlphaRemap.x;
				half temp_output_10_0_g24357 = ( _MainTexAlphaRemap.y - temp_output_7_0_g24357 );
				half Element_Remap_A74_g24346 = saturate( ( ( clampResult17_g24377 - temp_output_7_0_g24357 ) / ( temp_output_10_0_g24357 + 0.0001 ) ) );
				half Element_Params_A1737_g24346 = _ElementParams_Instance.w;
				half clampResult17_g24355 = clamp( saturate( ( 1.0 - distance( (i.ase_texcoord2.xy*2.0 + -1.0) , float2( 0,0 ) ) ) ) , 0.0001 , 0.9999 );
				half temp_output_7_0_g24356 = _MainTexFalloffRemap.x;
				half temp_output_10_0_g24356 = ( _MainTexFalloffRemap.y - temp_output_7_0_g24356 );
				half Element_Falloff1883_g24346 = saturate( ( ( clampResult17_g24355 - temp_output_7_0_g24356 ) / ( temp_output_10_0_g24356 + 0.0001 ) ) );
				half temp_output_7_0_g24381 = 1.0;
				half temp_output_10_0_g24381 = ( _ElementVolumeFadeValue - temp_output_7_0_g24381 );
				half lerpResult18_g24379 = lerp( 1.0 , saturate( ( ( saturate( ( distance( WorldPosition , (TVE_RenderBasePositionR).xyz ) / (TVE_RenderBasePositionR).w ) ) - temp_output_7_0_g24381 ) / temp_output_10_0_g24381 ) ) , _ElementVolumeFadeMode);
				half Element_Alpha56_g24346 = ( _ElementIntensity * Element_Remap_A74_g24346 * Element_Params_A1737_g24346 * i.ase_color.a * Element_Falloff1883_g24346 * lerpResult18_g24379 );
...
#define _ElementParams_arr BOXOPHOBICTheVisualEngineElementsAtmoWetness
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half3 Input_Color94_g24363 = temp_cast_3;
				half3 break68_g24363 = Input_Color94_g24363;
				half clampResult80_g24363 = clamp( max( max( break68_g24363.x , break68_g24363.y ) , break68_g24363.z ) , 0.1 , 10000.0 );
				half4 color1873_g24346 = IsGammaSpace() ? half4(0,0.7,0.6,0) : half4(0,0.4479884,0.3185468,0);
				half3 Input_Tint76_g24363 = (color1873_g24346).rgb;
				half3 Element_Valid47_g24363 = ( clampResult80_g24363 * Input_Tint76_g24363 );
				half clampResult17_g24377 = clamp( (MainTex_RGBA587_g24346).a , 0.0001 , 0.9999 );
				half temp_output_7_0_g24357 = _MainTexAlphaRemap.x;
				half temp_output_10_0_g24357 = ( _MainTexAlphaRemap.y - temp_output_7_0_g24357 );
				half Element_Remap_A74_g24346 = saturate( ( ( clampResult17_g24377 - temp_output_7_0_g24357 ) / ( temp_output_10_0_g24357 + 0.0001 ) ) );
				...
				half Element_Alpha56_g24346 = ( _ElementIntensity * Element_Remap_A74_g24346 * Element_Params_A1737_g24346 * i.ase_color.a * Element_Falloff1883_g24346 * lerpResult18_g24379 );
				half Final_Extras_A241_g24346 = Element_Alpha56_g24346;
				half Input_Alpha48_g24363 = Final_Extras_A241_g24346;
				half4 appendResult58_g24363 = (half4(Element_Valid47_g24363 , Input_Alpha48_g24363));
				
				
				finalColor = appendResult58_g24363;
				return finalColor;
			}
			ENDCG
		}
...
Node;AmplifyShaderEditor.FunctionNode;173;0,-1280;Inherit;False;Element Shader;10;;24346;0e972c73cae2ee54ea51acc9738801d0;12,477,1,1778,1,478,0,1824,0,1814,1,145,1,1784,0,481,0,1935,1,1933,1,1904,1,1907,1;1;1974;FLOAT;0;False;2;FLOAT4;0;FLOAT4;1779
