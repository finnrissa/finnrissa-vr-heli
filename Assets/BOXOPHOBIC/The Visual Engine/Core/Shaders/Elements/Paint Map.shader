...
#define _ElementParams_arr BOXOPHOBICTheVisualEngineElementsPaintMap
			...
			v2f vert ( appdata v )
			{
				...
				half2 vertexToFrag11_g24830 = ( ( lerpResult1899_g24794 * (_MainUVs).xy ) + (_MainUVs).zw );
				o.ase_texcoord1.xy = vertexToFrag11_g24830;
				...
				half temp_output_7_0_g24820 = _SeasonRemap.x;
				half temp_output_10_0_g24820 = ( _SeasonRemap.y - temp_output_7_0_g24820 );
				half TVE_SeasonLerp54_g24794 = saturate( saturate( ( ( TVE_SeasonLerp - temp_output_7_0_g24820 ) / temp_output_10_0_g24820 ) ) );
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half2 vertexToFrag11_g24830 = i.ase_texcoord1.xy;
				half4 MainTex_RGBA587_g24794 = tex2D( _MainTex, vertexToFrag11_g24830 );
				half3 temp_cast_0 = (0.0001).xxx;
				half3 temp_cast_1 = (0.9999).xxx;
				half3 clampResult17_g24824 = clamp( (MainTex_RGBA587_g24794).rgb , temp_cast_0 , temp_cast_1 );
				half temp_output_7_0_g24806 = _MainTexColorRemap.x;
				half3 temp_cast_2 = (temp_output_7_0_g24806).xxx;
				half temp_output_10_0_g24806 = ( _MainTexColorRemap.y - temp_output_7_0_g24806 );
				half3 temp_output_1765_0_g24794 = saturate( ( ( clampResult17_g24824 - temp_cast_2 ) / temp_output_10_0_g24806 ) );
				...
				half clampResult17_g24825 = clamp( (MainTex_RGBA587_g24794).a , 0.0001 , 0.9999 );
				half temp_output_7_0_g24805 = _MainTexAlphaRemap.x;
				half temp_output_10_0_g24805 = ( _MainTexAlphaRemap.y - temp_output_7_0_g24805 );
				half Element_Remap_A74_g24794 = saturate( ( ( clampResult17_g24825 - temp_output_7_0_g24805 ) / ( temp_output_10_0_g24805 + 0.0001 ) ) );
				half4 _ElementParams_Instance = UNITY_ACCESS_INSTANCED_PROP(_ElementParams_arr, _ElementParams);
				half Element_Params_A1737_g24794 = _ElementParams_Instance.w;
				half clampResult17_g24803 = clamp( saturate( ( 1.0 - distance( (i.ase_texcoord1.zw*2.0 + -1.0) , float2( 0,0 ) ) ) ) , 0.0001 , 0.9999 );
				half temp_output_7_0_g24804 = _MainTexFalloffRemap.x;
				half temp_output_10_0_g24804 = ( _MainTexFalloffRemap.y - temp_output_7_0_g24804 );
				half Element_Falloff1883_g24794 = saturate( ( ( clampResult17_g24803 - temp_output_7_0_g24804 ) / ( temp_output_10_0_g24804 + 0.0001 ) ) );
				half temp_output_7_0_g24829 = 1.0;
				half temp_output_10_0_g24829 = ( _ElementVolumeFadeValue - temp_output_7_0_g24829 );
				half lerpResult18_g24827 = lerp( 1.0 , saturate( ( ( saturate( ( distance( WorldPosition , (TVE_RenderBasePositionR).xyz ) / (TVE_RenderBasePositionR).w ) ) - temp_output_7_0_g24829 ) / temp_output_10_0_g24829 ) ) , _ElementVolumeFadeMode);
				half Element_Alpha56_g24794 = ( _ElementIntensity * Element_Remap_A74_g24794 * Element_Params_A1737_g24794 * i.ase_color.a * Element_Falloff1883_g24794 * lerpResult18_g24827 );
...
#define _ElementParams_arr BOXOPHOBICTheVisualEngineElementsPaintMap
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half3 Element_Remap_RGB1555_g24794 = temp_output_1765_0_g24794;
				half3 Final_ColorsMap_RGB598_g24794 = ( (Color_Main_RGBA49_g24794).rgb * Element_Remap_RGB1555_g24794 );
				half3 Input_Color94_g24808 = Final_ColorsMap_RGB598_g24794;
				half3 Element_Valid47_g24808 = Input_Color94_g24808;
				half clampResult17_g24825 = clamp( (MainTex_RGBA587_g24794).a , 0.0001 , 0.9999 );
				half temp_output_7_0_g24805 = _MainTexAlphaRemap.x;
				half temp_output_10_0_g24805 = ( _MainTexAlphaRemap.y - temp_output_7_0_g24805 );
				half Element_Remap_A74_g24794 = saturate( ( ( clampResult17_g24825 - temp_output_7_0_g24805 ) / ( temp_output_10_0_g24805 + 0.0001 ) ) );
				...
				half Element_Seasons834_g24794 = vertexToFrag11_g24797;
				half Final_ColorsMap_A603_g24794 = ( Element_Alpha56_g24794 * Element_Seasons834_g24794 );
				half Input_Alpha48_g24808 = Final_ColorsMap_A603_g24794;
				half4 appendResult58_g24808 = (half4(Element_Valid47_g24808 , Input_Alpha48_g24808));
				
				
				finalColor = appendResult58_g24808;
				return finalColor;
			}
			ENDCG
		}
...
Node;AmplifyShaderEditor.RangedFloatNode;139;-640,-640;Half;False;Property;_render_colormask;_render_colormask;69;1;[HideInInspector];Create;True;0;0;0;True;0;False;15;15;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;158;-384,-384;Inherit;False;Element Shader;10;;24794;0e972c73cae2ee54ea51acc9738801d0;12,477,0,1778,0,478,1,1824,1,1814,0,145,0,1784,0,481,0,1935,1,1933,1,1904,1,1907,1;1;1974;FLOAT;1;False;2;FLOAT4;0;FLOAT4;1779
