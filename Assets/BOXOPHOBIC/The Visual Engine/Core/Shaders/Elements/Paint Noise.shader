...
#define _ElementParams_arr BOXOPHOBICTheVisualEngineElementsPaintNoise
			...
			v2f vert ( appdata v )
			{
				...
				o.ase_texcoord1.zw = vertexToFrag11_g24830;
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half2 vertexToFrag11_g24830 = i.ase_texcoord1.zw;
				...
				half clampResult17_g24803 = clamp( saturate( ( 1.0 - distance( (i.ase_texcoord1.xy*2.0 + -1.0) , float2( 0,0 ) ) ) ) , 0.0001 , 0.9999 );
...
#define _ElementParams_arr BOXOPHOBICTheVisualEngineElementsPaintNoise
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half4 lerpResult772_g24794 = lerp( _NoiseColorOne , _NoiseColorTwo , WorldNoise1483_g24794);
				half3 Final_ColorsNoise_RGB784_g24794 = (lerpResult772_g24794).rgb;
				half3 Input_Color94_g24809 = Final_ColorsNoise_RGB784_g24794;
				half3 Element_Valid47_g24809 = Input_Color94_g24809;
				half2 vertexToFrag11_g24830 = i.ase_texcoord1.zw;
				half4 MainTex_RGBA587_g24794 = tex2D( _MainTex, vertexToFrag11_g24830 );
				half clampResult17_g24825 = clamp( (MainTex_RGBA587_g24794).a , 0.0001 , 0.9999 );
				half temp_output_7_0_g24805 = _MainTexAlphaRemap.x;
				...
				half Element_Seasons834_g24794 = vertexToFrag11_g24797;
				half Final_ColorsNoise_A785_g24794 = ( (lerpResult772_g24794).a * Element_Alpha56_g24794 * Element_Seasons834_g24794 );
				half Input_Alpha48_g24809 = Final_ColorsNoise_A785_g24794;
...
Node;AmplifyShaderEditor.FunctionNode;185;-384,-384;Inherit;False;Element Shader;10;;24794;0e972c73cae2ee54ea51acc9738801d0;12,477,0,1778,0,478,2,1824,2,1814,0,145,0,1784,0,481,0,1935,1,1933,1,1904,1,1907,1;1;1974;FLOAT;1;False;2;FLOAT4;0;FLOAT4;1779
...
Node;AmplifyShaderEditor.RangedFloatNode;159;-640,-640;Half;False;Property;_render_colormask;_render_colormask;69;1;[HideInInspector];Create;True;0;0;0;True;0;False;15;15;0;0;0;1;FLOAT;0
