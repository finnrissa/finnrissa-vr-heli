...
#define _ElementParams_arr BOXOPHOBICTheVisualEngineElementsPushInteractionSimple
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				#endif
				half4 MainTex_RGBA587_g23879 = tex2D( _MainTex, ( 1.0 - i.ase_texcoord1.xy ) );
				float3 temp_cast_0 = (0.0001).xxx;
				float3 temp_cast_1 = (0.9999).xxx;
				float3 clampResult17_g23909 = clamp( (MainTex_RGBA587_g23879).rgb , temp_cast_0 , temp_cast_1 );
				float temp_output_7_0_g23891 = _MainTexColorRemap.x;
				float3 temp_cast_2 = (temp_output_7_0_g23891).xxx;
				float temp_output_10_0_g23891 = ( _MainTexColorRemap.y - temp_output_7_0_g23891 );
				float3 temp_output_1765_0_g23879 = saturate( ( ( clampResult17_g23909 - temp_cast_2 ) / temp_output_10_0_g23891 ) );
				half Element_Remap_R73_g23879 = (temp_output_1765_0_g23879).x;
				half Element_Remap_G265_g23879 = (temp_output_1765_0_g23879).y;
				float3 appendResult274_g23879 = (float3((Element_Remap_R73_g23879*2.0 + -1.0) , 0.0 , (Element_Remap_G265_g23879*2.0 + -1.0)));
				float3 ase_objectScale = float3( length( unity_ObjectToWorld[ 0 ].xyz ), length( unity_ObjectToWorld[ 1 ].xyz ), length( unity_ObjectToWorld[ 2 ].xyz ) );
				float3 break281_g23879 = ( mul( unity_ObjectToWorld, float4( appendResult274_g23879 , 0.0 ) ).xyz / ase_objectScale );
				float2 appendResult1403_g23879 = (float2(break281_g23879.x , break281_g23879.z));
				half2 Direction_Texture284_g23879 = appendResult1403_g23879;
				half Element_InvertMode489_g23879 = _ElementInvertMode;
				float2 lerpResult1471_g23879 = lerp( Direction_Texture284_g23879 , -Direction_Texture284_g23879 , Element_InvertMode489_g23879);
				float3 appendResult292_g23879 = (float3(saturate( (lerpResult1471_g23879*0.5 + 0.5) ) , 0.0));
				half3 Final_MotionInteraction_RGB303_g23879 = appendResult292_g23879;
				float clampResult17_g23910 = clamp( (MainTex_RGBA587_g23879).a , 0.0001 , 0.9999 );
				float temp_output_7_0_g23890 = _MainTexAlphaRemap.x;
				float temp_output_10_0_g23890 = ( _MainTexAlphaRemap.y - temp_output_7_0_g23890 );
				half Element_Remap_A74_g23879 = saturate( ( ( clampResult17_g23910 - temp_output_7_0_g23890 ) / ( temp_output_10_0_g23890 + 0.0001 ) ) );
				half4 _ElementParams_Instance = UNITY_ACCESS_INSTANCED_PROP(_ElementParams_arr, _ElementParams);
				half Element_Params_A1737_g23879 = _ElementParams_Instance.w;
				half Element_Falloff1883_g23879 = 1.0;
				float temp_output_7_0_g23914 = 1.0;
				float temp_output_10_0_g23914 = ( _ElementVolumeFadeValue - temp_output_7_0_g23914 );
				float lerpResult18_g23912 = lerp( 1.0 , saturate( ( ( saturate( ( distance( WorldPosition , (TVE_RenderBasePositionR).xyz ) / (TVE_RenderBasePositionR).w ) ) - temp_output_7_0_g23914 ) / temp_output_10_0_g23914 ) ) , _ElementVolumeFadeMode);
				half Element_Alpha56_g23879 = ( _ElementIntensity * Element_Remap_A74_g23879 * Element_Params_A1737_g23879 * i.ase_color.a * Element_Falloff1883_g23879 * lerpResult18_g23912 );
				half Final_MotionInteraction_A305_g23879 = Element_Alpha56_g23879;
				float4 appendResult479_g23879 = (float4(Final_MotionInteraction_RGB303_g23879 , Final_MotionInteraction_A305_g23879));
				
				
				finalColor = appendResult479_g23879;
				return finalColor;
			}
			ENDCG
		}
...
#define _ElementParams_arr BOXOPHOBICTheVisualEngineElementsPushInteractionSimple
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				float3 appendResult292_g23879 = (float3(saturate( (lerpResult1471_g23879*0.5 + 0.5) ) , 0.0));
				half3 Final_MotionInteraction_RGB303_g23879 = appendResult292_g23879;
				half3 Input_Color94_g23900 = Final_MotionInteraction_RGB303_g23879;
				half3 Element_Valid47_g23900 = ( Input_Color94_g23900 * Input_Color94_g23900 );
				float clampResult17_g23910 = clamp( (MainTex_RGBA587_g23879).a , 0.0001 , 0.9999 );
				float temp_output_7_0_g23890 = _MainTexAlphaRemap.x;
				float temp_output_10_0_g23890 = ( _MainTexAlphaRemap.y - temp_output_7_0_g23890 );
				half Element_Remap_A74_g23879 = saturate( ( ( clampResult17_g23910 - temp_output_7_0_g23890 ) / ( temp_output_10_0_g23890 + 0.0001 ) ) );
				...
				half Element_Alpha56_g23879 = ( _ElementIntensity * Element_Remap_A74_g23879 * Element_Params_A1737_g23879 * i.ase_color.a * Element_Falloff1883_g23879 * lerpResult18_g23912 );
				half Final_MotionInteraction_A305_g23879 = Element_Alpha56_g23879;
				half Input_Alpha48_g23900 = Final_MotionInteraction_A305_g23879;
				float4 appendResult58_g23900 = (float4(Element_Valid47_g23900 , Input_Alpha48_g23900));
				
				
				finalColor = appendResult58_g23900;
				return finalColor;
			}
			ENDCG
		}
...
Node;AmplifyShaderEditor.RangedFloatNode;197;-640,-1152;Half;False;Property;_render_colormask;_render_colormask;69;1;[HideInInspector];Create;True;0;0;0;True;0;False;15;15;0;0;0;1;FLOAT;0
