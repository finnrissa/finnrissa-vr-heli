...
#define _ElementParams_arr BOXOPHOBICTheVisualEngineElementsPaintTinting
			...
			v2f vert ( appdata v )
			{
				...
				half temp_output_7_0_g25598 = _SeasonRemap.x;
				half temp_output_10_0_g25598 = ( _SeasonRemap.y - temp_output_7_0_g25598 );
				half TVE_SeasonLerp54_g25572 = saturate( saturate( ( ( TVE_SeasonLerp - temp_output_7_0_g25598 ) / temp_output_10_0_g25598 ) ) );
				...
				half2 vertexToFrag11_g25608 = ( ( lerpResult1899_g25572 * (_MainUVs).xy ) + (_MainUVs).zw );
				o.ase_texcoord2.xy = vertexToFrag11_g25608;
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half2 vertexToFrag11_g25608 = i.ase_texcoord2.xy;
				half4 MainTex_RGBA587_g25572 = tex2D( _MainTex, vertexToFrag11_g25608 );
				half3 temp_cast_0 = (0.0001).xxx;
				half3 temp_cast_1 = (0.9999).xxx;
				half3 clampResult17_g25602 = clamp( (MainTex_RGBA587_g25572).rgb , temp_cast_0 , temp_cast_1 );
				half temp_output_7_0_g25584 = _MainTexColorRemap.x;
				half3 temp_cast_2 = (temp_output_7_0_g25584).xxx;
				half temp_output_10_0_g25584 = ( _MainTexColorRemap.y - temp_output_7_0_g25584 );
				half3 temp_output_1765_0_g25572 = saturate( ( ( clampResult17_g25602 - temp_cast_2 ) / temp_output_10_0_g25584 ) );
				...
				half clampResult17_g25603 = clamp( (MainTex_RGBA587_g25572).a , 0.0001 , 0.9999 );
				half temp_output_7_0_g25583 = _MainTexAlphaRemap.x;
				half temp_output_10_0_g25583 = ( _MainTexAlphaRemap.y - temp_output_7_0_g25583 );
				half Element_Remap_A74_g25572 = saturate( ( ( clampResult17_g25603 - temp_output_7_0_g25583 ) / ( temp_output_10_0_g25583 + 0.0001 ) ) );
				half Element_Params_A1737_g25572 = _ElementParams_Instance.w;
				half clampResult17_g25581 = clamp( saturate( ( 1.0 - distance( (i.ase_texcoord2.zw*2.0 + -1.0) , float2( 0,0 ) ) ) ) , 0.0001 , 0.9999 );
				half temp_output_7_0_g25582 = _MainTexFalloffRemap.x;
				half temp_output_10_0_g25582 = ( _MainTexFalloffRemap.y - temp_output_7_0_g25582 );
				half Element_Falloff1883_g25572 = saturate( ( ( clampResult17_g25581 - temp_output_7_0_g25582 ) / ( temp_output_10_0_g25582 + 0.0001 ) ) );
				half temp_output_7_0_g25607 = 1.0;
				half temp_output_10_0_g25607 = ( _ElementVolumeFadeValue - temp_output_7_0_g25607 );
				half lerpResult18_g25605 = lerp( 1.0 , saturate( ( ( saturate( ( distance( WorldPosition , (TVE_RenderBasePositionR).xyz ) / (TVE_RenderBasePositionR).w ) ) - temp_output_7_0_g25607 ) / temp_output_10_0_g25607 ) ) , _ElementVolumeFadeMode);
				half Element_Alpha56_g25572 = ( _ElementIntensity * Element_Remap_A74_g25572 * Element_Params_A1737_g25572 * i.ase_color.a * Element_Falloff1883_g25572 * lerpResult18_g25605 );
...
#define _ElementParams_arr BOXOPHOBICTheVisualEngineElementsPaintTinting
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half3 Element_Color1756_g25572 = ( Element_Remap_RGB1555_g25572 * Element_Params_RGB1735_g25572 * (i.ase_color).rgb );
				half3 Final_Colors_RGB142_g25572 = ( (lerpResult30_g25572).rgb * Element_Color1756_g25572 );
				half3 Input_Color94_g25585 = Final_Colors_RGB142_g25572;
				half3 Element_Valid47_g25585 = Input_Color94_g25585;
				half clampResult17_g25603 = clamp( (MainTex_RGBA587_g25572).a , 0.0001 , 0.9999 );
				half temp_output_7_0_g25583 = _MainTexAlphaRemap.x;
				half temp_output_10_0_g25583 = ( _MainTexAlphaRemap.y - temp_output_7_0_g25583 );
				half Element_Remap_A74_g25572 = saturate( ( ( clampResult17_g25603 - temp_output_7_0_g25583 ) / ( temp_output_10_0_g25583 + 0.0001 ) ) );
				...
				half Element_Alpha56_g25572 = ( _ElementIntensity * Element_Remap_A74_g25572 * Element_Params_A1737_g25572 * i.ase_color.a * Element_Falloff1883_g25572 * lerpResult18_g25605 );
				half Final_Colors_A144_g25572 = ( (lerpResult30_g25572).a * Element_Alpha56_g25572 );
				half Input_Alpha48_g25585 = Final_Colors_A144_g25572;
				half4 appendResult58_g25585 = (half4(Element_Valid47_g25585 , Input_Alpha48_g25585));
				
				
				finalColor = appendResult58_g25585;
				return finalColor;
			}
			ENDCG
		}
...
Node;AmplifyShaderEditor.RangedFloatNode;178;-640,-640;Half;False;Property;_render_colormask;_render_colormask;69;1;[HideInInspector];Create;True;0;0;0;True;0;False;15;15;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;401;-384,-384;Inherit;False;Element Shader;10;;25572;0e972c73cae2ee54ea51acc9738801d0;12,477,0,1778,0,478,0,1824,0,1814,0,145,0,1784,0,481,0,1935,1,1933,1,1904,1,1907,1;1;1974;FLOAT;0;False;2;FLOAT4;0;FLOAT4;1779
