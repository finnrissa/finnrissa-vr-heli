...
#define _ElementParams_arr BOXOPHOBICTheVisualEngineElementsPaintIntensity
			...
			v2f vert ( appdata v )
			{
				...
				half temp_output_7_0_g24821 = _SeasonRemap.x;
				half temp_output_10_0_g24821 = ( _SeasonRemap.y - temp_output_7_0_g24821 );
				half TVE_SeasonLerp54_g24795 = saturate( saturate( ( ( TVE_SeasonLerp - temp_output_7_0_g24821 ) / temp_output_10_0_g24821 ) ) );
				...
				half2 vertexToFrag11_g24831 = ( ( lerpResult1899_g24795 * (_MainUVs).xy ) + (_MainUVs).zw );
				o.ase_texcoord1.yz = vertexToFrag11_g24831;
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half2 vertexToFrag11_g24831 = i.ase_texcoord1.yz;
				half4 MainTex_RGBA587_g24795 = tex2D( _MainTex, vertexToFrag11_g24831 );
				half3 temp_cast_0 = (0.0001).xxx;
				half3 temp_cast_1 = (0.9999).xxx;
				half3 clampResult17_g24825 = clamp( (MainTex_RGBA587_g24795).rgb , temp_cast_0 , temp_cast_1 );
				half temp_output_7_0_g24807 = _MainTexColorRemap.x;
				half3 temp_cast_2 = (temp_output_7_0_g24807).xxx;
				half temp_output_10_0_g24807 = ( _MainTexColorRemap.y - temp_output_7_0_g24807 );
				half3 temp_output_1765_0_g24795 = saturate( ( ( clampResult17_g24825 - temp_cast_2 ) / temp_output_10_0_g24807 ) );
				...
				half clampResult17_g24826 = clamp( (MainTex_RGBA587_g24795).a , 0.0001 , 0.9999 );
				half temp_output_7_0_g24806 = _MainTexAlphaRemap.x;
				half temp_output_10_0_g24806 = ( _MainTexAlphaRemap.y - temp_output_7_0_g24806 );
				half Element_Remap_A74_g24795 = saturate( ( ( clampResult17_g24826 - temp_output_7_0_g24806 ) / ( temp_output_10_0_g24806 + 0.0001 ) ) );
				half Element_Params_A1737_g24795 = _ElementParams_Instance.w;
				half clampResult17_g24804 = clamp( saturate( ( 1.0 - distance( (i.ase_texcoord2.xy*2.0 + -1.0) , float2( 0,0 ) ) ) ) , 0.0001 , 0.9999 );
				half temp_output_7_0_g24805 = _MainTexFalloffRemap.x;
				half temp_output_10_0_g24805 = ( _MainTexFalloffRemap.y - temp_output_7_0_g24805 );
				half Element_Falloff1883_g24795 = saturate( ( ( clampResult17_g24804 - temp_output_7_0_g24805 ) / ( temp_output_10_0_g24805 + 0.0001 ) ) );
				half temp_output_7_0_g24830 = 1.0;
				half temp_output_10_0_g24830 = ( _ElementVolumeFadeValue - temp_output_7_0_g24830 );
				half lerpResult18_g24828 = lerp( 1.0 , saturate( ( ( saturate( ( distance( WorldPosition , (TVE_RenderBasePositionR).xyz ) / (TVE_RenderBasePositionR).w ) ) - temp_output_7_0_g24830 ) / temp_output_10_0_g24830 ) ) , _ElementVolumeFadeMode);
				half Element_Alpha56_g24795 = ( _ElementIntensity * Element_Remap_A74_g24795 * Element_Params_A1737_g24795 * i.ase_color.a * Element_Falloff1883_g24795 * lerpResult18_g24828 );
...
#define _ElementParams_arr BOXOPHOBICTheVisualEngineElementsPaintIntensity
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half3 Input_Color94_g24811 = temp_cast_3;
				half3 break68_g24811 = Input_Color94_g24811;
				half clampResult80_g24811 = clamp( max( max( break68_g24811.x , break68_g24811.y ) , break68_g24811.z ) , 0.1 , 10000.0 );
				half4 color1871_g24795 = IsGammaSpace() ? half4(1,0.5,0.5,0) : half4(1,0.2140411,0.2140411,0);
				half3 Input_Tint76_g24811 = (color1871_g24795).rgb;
				half3 Element_Valid47_g24811 = ( clampResult80_g24811 * Input_Tint76_g24811 );
				half clampResult17_g24826 = clamp( (MainTex_RGBA587_g24795).a , 0.0001 , 0.9999 );
				half temp_output_7_0_g24806 = _MainTexAlphaRemap.x;
				half temp_output_10_0_g24806 = ( _MainTexAlphaRemap.y - temp_output_7_0_g24806 );
				half Element_Remap_A74_g24795 = saturate( ( ( clampResult17_g24826 - temp_output_7_0_g24806 ) / ( temp_output_10_0_g24806 + 0.0001 ) ) );
				...
				half Input_Alpha48_g24811 = Final_Extras_A241_g24795;
				half4 appendResult58_g24811 = (half4(Element_Valid47_g24811 , Input_Alpha48_g24811));
				
				
				finalColor = appendResult58_g24811;
				return finalColor;
			}
			ENDCG
		}
...
Node;AmplifyShaderEditor.FunctionNode;250;-384,-384;Inherit;False;Element Shader;10;;24795;0e972c73cae2ee54ea51acc9738801d0;12,477,0,1778,0,478,3,1824,3,1814,3,145,3,1784,0,481,0,1935,1,1933,1,1904,1,1907,1;1;1974;FLOAT;0;False;2;FLOAT4;0;FLOAT4;1779
