...
#define _ElementParams_arr BOXOPHOBICTheVisualEngineElementsGlowEmissive
			...
			v2f vert ( appdata v )
			{
				...
				float temp_output_7_0_g23664 = _SeasonRemap.x;
				float temp_output_10_0_g23664 = ( _SeasonRemap.y - temp_output_7_0_g23664 );
				...
				float2 vertexToFrag11_g23674 = ( ( lerpResult1899_g23638 * (_MainUVs).xy ) + (_MainUVs).zw );
				o.ase_texcoord2.xy = vertexToFrag11_g23674;
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				float2 vertexToFrag11_g23674 = i.ase_texcoord2.xy;
				...
				float3 clampResult17_g23668 = clamp( (MainTex_RGBA587_g23638).rgb , temp_cast_0 , temp_cast_1 );
				float temp_output_7_0_g23650 = _MainTexColorRemap.x;
				float3 temp_cast_2 = (temp_output_7_0_g23650).xxx;
				float temp_output_10_0_g23650 = ( _MainTexColorRemap.y - temp_output_7_0_g23650 );
				float3 temp_output_1765_0_g23638 = saturate( ( ( clampResult17_g23668 - temp_cast_2 ) / temp_output_10_0_g23650 ) );
				...
				float clampResult17_g23669 = clamp( (MainTex_RGBA587_g23638).a , 0.0001 , 0.9999 );
				float temp_output_7_0_g23649 = _MainTexAlphaRemap.x;
				float temp_output_10_0_g23649 = ( _MainTexAlphaRemap.y - temp_output_7_0_g23649 );
				...
				float clampResult17_g23647 = clamp( saturate( ( 1.0 - distance( (i.ase_texcoord2.zw*2.0 + -1.0) , float2( 0,0 ) ) ) ) , 0.0001 , 0.9999 );
				float temp_output_7_0_g23648 = _MainTexFalloffRemap.x;
				float temp_output_10_0_g23648 = ( _MainTexFalloffRemap.y - temp_output_7_0_g23648 );
				half Element_Falloff1883_g23638 = saturate( ( ( clampResult17_g23647 - temp_output_7_0_g23648 ) / ( temp_output_10_0_g23648 + 0.0001 ) ) );
				float temp_output_7_0_g23673 = 1.0;
				float temp_output_10_0_g23673 = ( _ElementVolumeFadeValue - temp_output_7_0_g23673 );
				float lerpResult18_g23671 = lerp( 1.0 , saturate( ( ( saturate( ( distance( WorldPosition , (TVE_RenderBasePositionR).xyz ) / (TVE_RenderBasePositionR).w ) ) - temp_output_7_0_g23673 ) / temp_output_10_0_g23673 ) ) , _ElementVolumeFadeMode);
...
#define _ElementParams_arr BOXOPHOBICTheVisualEngineElementsGlowEmissive
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half3 Element_Color1756_g23638 = ( Element_Remap_RGB1555_g23638 * Element_Params_RGB1735_g23638 * (i.ase_color).rgb );
				half3 Final_Colors_RGB142_g23638 = ( (lerpResult30_g23638).rgb * Element_Color1756_g23638 );
				half3 Input_Color94_g23651 = Final_Colors_RGB142_g23638;
				half3 Element_Valid47_g23651 = Input_Color94_g23651;
				float clampResult17_g23669 = clamp( (MainTex_RGBA587_g23638).a , 0.0001 , 0.9999 );
				float temp_output_7_0_g23649 = _MainTexAlphaRemap.x;
				float temp_output_10_0_g23649 = ( _MainTexAlphaRemap.y - temp_output_7_0_g23649 );
				half Element_Remap_A74_g23638 = saturate( ( ( clampResult17_g23669 - temp_output_7_0_g23649 ) / ( temp_output_10_0_g23649 + 0.0001 ) ) );
				...
				half Element_Alpha56_g23638 = ( _ElementIntensity * Element_Remap_A74_g23638 * Element_Params_A1737_g23638 * i.ase_color.a * Element_Falloff1883_g23638 * lerpResult18_g23671 );
				half Final_Colors_A144_g23638 = ( (lerpResult30_g23638).a * Element_Alpha56_g23638 );
				half Input_Alpha48_g23651 = Final_Colors_A144_g23638;
				float4 appendResult58_g23651 = (float4(Element_Valid47_g23651 , Input_Alpha48_g23651));
				
				
				finalColor = appendResult58_g23651;
				return finalColor;
			}
			ENDCG
		}
...
Node;AmplifyShaderEditor.FunctionNode;142;-384,-1152;Inherit;False;Element Shader;10;;23638;0e972c73cae2ee54ea51acc9738801d0;12,477,0,1778,0,478,0,1824,0,1814,0,145,0,1784,0,481,0,1935,1,1933,1,1904,1,1907,1;1;1974;FLOAT;1;False;2;FLOAT4;0;FLOAT4;1779
