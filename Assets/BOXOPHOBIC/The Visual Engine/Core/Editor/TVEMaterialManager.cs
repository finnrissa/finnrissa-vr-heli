...
namespace TheVisualEngine
{
    public class TVEMaterialManager : EditorWindow
    {
        ...
        {
        "All Material Settings", "Render Settings", "Surface Settings", "Coloring Settings", "Atmospheric Settings", "Dithering Settings", "Glowing Settings", "Transform Settings", "Motion Settings", "Normal Settings",
        };
        ...
        List<TVEPropertyData> atmosphericDataGlobal = new List<TVEPropertyData>
        {
            new TVEPropertyData("_GlobalCategory", "Global Settings"),
        ...
        List<TVEPropertyData> atmosphericData = new List<TVEPropertyData>
        {
            ...
            new TVEPropertyData("_WetnessWaterColor", "Wetness Water Color", new Color(-9000, 0,0,0), true, true),
            new TVEPropertyData("_WetnessWaterBaseRemap", "Wetness Water Base Mask", new Vector4(-9000, 0, 0, -9000), 0, 1, false),
        ...
        List<TVEPropertyData> ditherData = new List<TVEPropertyData>
        {
        ...
        List<TVEPropertyData> normalData = new List<TVEPropertyData>
        {
            ...
            new TVEPropertyData("_NormalBlanketProjRemap", "Blanket ProjY Mask", new Vector4(-9000, 0, 0, -9000), 0, 1, true),
            new TVEPropertyData("_NormalBlanketLandValue", "Blanket Land Mask", -9000, 0, 8, false, false),
            new TVEPropertyData("_NormalBlanketLandMode", "Blanket Land Mask", -9000, "Additive 0 Multiply_Additive 1", false),
        };
        ...
        void PopulateMaterialDataSet()
        {
            ...
            if (settingsIndex == 0)
            {
                ...
                propertyDataSet.AddRange(atmosphericData);
                propertyDataSet.AddRange(ditherData);
            ...
            {
                propertyDataSet.AddRange(atmosphericDataGlobal);
                propertyDataSet.AddRange(atmosphericData);
            }
            ...
            if (GUILayout.Button("Save Preset", GUILayout.Height(GUI_HEIGHT), GUILayout.MaxWidth(GUI_HALF_EDITOR_WIDTH)))
            {
                ...
                if (savePath != "")
                {
                    ...
                    if (savingIndex == 0)
                    {
                        ...
                        savingDataSet.AddRange(atmosphericData);
                        savingDataSet.AddRange(ditherData);
