...
namespace TheVisualEngine
{
    public class TVEHub : EditorWindow
    {
        ...
        [MenuItem("Window/BOXOPHOBIC/The Visual Engine/Hub/The Visual Engine", false, 1000)]
        public static void ShowWindow()
        {
            window = GetWindow<TVEHub>(false, "The Visual Engine", true);
        ...
        void OnEnable()
        {
            ...
            bannerText = "The Visual Engine Hub";
        ...
        void OnGUI()
        {
            ...
            //{
            //    EditorGUILayout.HelpBox("Previous version detected! You must delete The Visual Engine folder before installing the new version!", MessageType.Error, true);
            ...
            if (requiresCompressionUpgrade)
            {
                ...
                {
                    EditorGUILayout.HelpBox("The vertex compression for Tex Coord 3 under Project Settings > Player Settings > Other Settings must be disabled for the pre-baked pivots to work correclty in builds! Optimize Mesh Data will be enabled to support the shaders as terrain details! Make sure to save the project settings for the chnages to take effect!", MessageType.Warning, true);
            ...
            {
                EditorGUILayout.HelpBox("Welcome to The Visual Engine! Choose the render pipeline used in your project to make the shaders compatible with the current pipeline!", MessageType.Info, true);
            ...
            {
                EditorGUILayout.HelpBox("The Visual Engine is installed for the " + pipelineCurrent + "! Use the additional setting below to restart the render pipeline setup.", MessageType.Info, true);
        ...
        void SetDefineSymbols()
        {
            ...
            if (!defineSymbols.Contains("THE_VISUAL_ENGINE"))
            {
                defineSymbols += ";THE_VISUAL_ENGINE;";
