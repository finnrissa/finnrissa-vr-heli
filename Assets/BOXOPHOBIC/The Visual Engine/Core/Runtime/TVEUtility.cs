...
namespace TheVisualEngine
{
    public class TVEUtils
    {
        ...
        const string minimumVersionFor6000 = "6000.0.15";
        ...
        public static void SetMaterialSettings(Material material)
        {
            ...
            if (material.HasProperty("_IsVersion"))
            {
                ...
                material.SetInt("_IsVersion", 2000);
#endif
            ...
            // Set Shadows Mode
            if (material.HasProperty("_RenderShadows"))
            {
                var mode = material.GetInt("_RenderShadows");
            ...
            //SetMaterialKeyword(material, "_EmissiveSampleMode", new string[] { "TVE_EMISSIVE_SAMPLE_MAIN_UV", "TVE_EMISSIVE_SAMPLE_EXTRA_UV", "TVE_EMISSIVE_SAMPLE_PLANAR_2D", "TVE_EMISSIVE_SAMPLE_PLANAR_3D" });
            ...
            string[] engineGPUInstancerPro = new string[]
{
        ...
        public static TVEProjectData GetProjectData()
        {
            ...
            string pipeline = "Built-in Pipeline";
    ...
    public class TVEGlobalAtmoData
    {
        ...
        [Tooltip("Controls the global alpha coutout.")]
        [Range(0.0f, 1.0f)]
