...
namespace TheVisualEngine
{
    ...
    public class TVEManager : StyledMonoBehaviour
    {
        ...
        void LateUpdate()
        {
            ...
            //Shader.SetGlobalFloat("TVE_MainCameraSpeedValue", Vector3.Magnitude(focusPosition) * 0.5f + Vector3.Magnitude(focusRotation) * 0.01f);
        ...
        void SetGlobalShaderProperties()
        {
            ...
            var atmoParams = new Color(globalAtmoData.drynessIntensity, globalAtmoData.wetnessIntensity, globalAtmoData.overlayIntensity, globalAtmoData.cutoutIntensity);
